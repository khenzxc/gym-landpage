...
export default function InvoiceLog({ members = [] }) {
  ...
  return (
    <div className="bg-zinc-950 border border-zinc-900 p-6 md:p-8 space-y-6">
      <div>
        <h4 className="text-lg font-bold uppercase tracking-tight text-white font-sans">
          System Audit Ledger
        </h4>
        <p className="text-xs text-zinc-500 font-mono">
          Real-time compilation of membership accounts and structural balance
        </p>
      </div>

      {/* ✅ SCROLL CONTAINER ADDED */}
      <div className="overflow-x-auto overflow-y-auto max-h-[280px] custom-scrollbar border border-zinc-900">
