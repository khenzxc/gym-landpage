...
import { Shield, Mail, Key, User, Calendar, Activity, Save, RefreshCw } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black text-white font-sans antialiased selection:bg-yellow-400 selection:text-black flex">
      ...
      <main className="flex-1 p-6 md:p-10 max-w-5xl mx-auto space-y-8 overflow-y-auto">
        ...
        <div className="border-b border-zinc-900 pb-6">
          <span className="text-xs font-mono tracking-widest text-zinc-500 block uppercase">// SECURE_CORE_PROFILE</span>
          <h2 className="text-3xl font-black uppercase tracking-tight">ADMIN_PROFILES_IDENTITY</h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-zinc-950 border border-zinc-900 p-6 text-center space-y-4 relative overflow-hidden">
              {/* Decorative Accent */}
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-zinc-950 border border-zinc-900 p-6 md:p-8 space-y-6">
              <div>
                <h4 className="text-sm font-bold font-mono text-zinc-400 uppercase tracking-wider">// IDENTITY_REGISTRY_FIELDS</h4>
                <p className="text-xs text-zinc-600 font-mono">Modify fundamental administration metadata protocols</p>
              </div>
              ...
              <form onSubmit={handleUpdateProfile} className="grid grid-cols-1 sm:grid-cols-2 gap-4 font-mono text-xs">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-black border border-zinc-900 focus:border-yellow-400 text-white p-3 pl-9 outline-none transition-colors rounded-none font-sans"
                    />
                  </div>
                </div>
                ...
                <div className="sm:col-span-2 pt-2 flex justify-end">
                  <button 
                    type="submit"
                    className="bg-zinc-900 border border-zinc-800 hover:border-yellow-400 text-zinc-400 hover:text-white font-mono text-xs px-5 py-3 flex items-center gap-2 transition-all"
                  >
                    <Save className="w-4 h-4" /> Save_Metadata
                  </button>
                </div>
              </form>
            </div>

            {/* FORM 2: SECURITY & CREDENTIAL ROTATION */}
            <div className="bg-zinc-950 border border-zinc-900 p-6 md:p-8 space-y-6">
              <div>
                <h4 className="text-sm font-bold font-mono text-zinc-400 uppercase tracking-wider">// SECURITY_PASSCODE_ROTATION</h4>
                <p className="text-xs text-zinc-600 font-mono">Rotate cryptographic tokens to prevent unauthorized system penetration</p>
              </div>
              ...
              <form onSubmit={handleUpdatePassword} className="space-y-4 font-mono text-xs">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      placeholder="••••••••••••"
                      className="w-full bg-black border border-zinc-900 focus:border-yellow-400 text-white p-3 pl-9 outline-none transition-colors rounded-none"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      placeholder="New sequence code"
                      className="w-full bg-black border border-zinc-900 focus:border-yellow-400 text-white p-3 outline-none transition-colors rounded-none"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      placeholder="Verify sequence code"
                      className="w-full bg-black border border-zinc-900 focus:border-yellow-400 text-white p-3 outline-none transition-colors rounded-none"
                    />
                  </div>
                </div>
                ...
                <div className="pt-2 flex justify-end">
                  <button 
                    type="submit"
                    className="bg-yellow-400 text-black font-black uppercase tracking-widest px-5 py-3 flex items-center gap-2 transition-all hover:bg-yellow-500"
                  >
                    <RefreshCw className="w-4 h-4" /> Rotate_Access_Codes
                  </button>
                </div>
              </form>
            </div>
